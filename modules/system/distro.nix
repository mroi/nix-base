	...
	config = lib.mkMerge [
		...
		(lib.mkIf (config.system.distribution == "macOS") {
			...
			system.files.known = [
				...
				"/Library/Apple/System/Library/LaunchAgents/com.apple.MRTa.plist"
				"/Library/Apple/System/Library/LaunchDaemons/com.apple.MRTd.plist"
				"/Library/Apple/System/Library/Preferences"
				"/Library/Apple/System/Library/Preferences/*"
