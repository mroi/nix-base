{ config, lib, pkgs, ... }: {
	...
	in {
		...
		system.files.connections = lib.mkIf pkgs.stdenv.hostPlatform.isDarwin (lib.concatMap (account: [
			...
			"(${home account}/Library/Containers/[^/]*)/Data/Library/Dictionaries"
		...
		system.files.used = lib.mkIf pkgs.stdenv.hostPlatform.isDarwin (lib.concatMap (account: [
			"${home account}/.Trash/*"
