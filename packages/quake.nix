...
stdenvNoCC.mkDerivation rec {
	...
	src = fetchurl {
		url = "https://github.com/MacSourcePorts/MSPBuildSystem/releases/download/vkQuake-1.33.0/vkQuake-1.33.0.dmg";
		hash = "sha256-MhTCojeviN9S77Hsfqj+4WrKw52gJLLJeEtcbfml2ew=";
	};
